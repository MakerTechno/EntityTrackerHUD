package nowebsite.makertechno.entity_tracker.core.tool;
...
public final class TextureBuildTool {
    ...
    public static <T extends TIcon> Optional<T> initTIcon(String name, ResourceLocation location, @NotNull Function4<String, ResourceLocation, Integer, Integer, T> element) {
        try {
            ...
            EntityTracker.LOGGER.warn("Failed to load texture: {}", location.getPath(), e);
        }
    ...
    private static void pushCacheConf(ResourceLocation location, Resource resource, NativeImage nativeimage) throws IOException{
        ...
        try {
            ...
            EntityTracker.LOGGER.warn("Failed reading metadata of: {}", location, runtimeexception);
