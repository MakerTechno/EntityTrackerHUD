...
public class TDir3BodyCursor extends TDirectTagCursor{
    ...
    private static @NotNull Transform renderStatic(@NotNull GuiGraphics graphics, float partialTick, @NotNull Player player, Vec3 target, TagPointerIconComponent component1, TagPointerIconComponent component2, TagPointerIconComponent component3, float scale, Transform tO) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            float r = (float) component1.getTagPointerIcon().height() * 1.6F * scale;
            ...
            matrix4fStack.translate(-(float) switch (i) {
                case 0 -> component1.getTagPointerIcon().width();
                case 1 -> component2.getTagPointerIcon().width();
                case 2 -> component3.getTagPointerIcon().width();
                default -> 0;
            } / 2f * scale, -(float) switch (i) {
                case 0 -> component1.getTagPointerIcon().height();
                case 1 -> component2.getTagPointerIcon().height();
                case 2 -> component3.getTagPointerIcon().height();
                default -> 0;
            } / 2f * scale, 0f);
